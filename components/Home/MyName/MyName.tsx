    ...
    >
      ...
      >
       I care deeply about building things that <span className="text-AAsecondary keyword-hover">matter</span>, products that make a real{" "}
        ...
        <span className="text-AAsecondary keyword-hover">hands-on</span> across the stack because I believe{" "}
        <span className="text-AAsecondary keyword-hover">execution</span> is just as important as{" "}
        <span className="text-AAsecondary keyword-hover">vision</span>.
        <br className="3xl:block hidden" /> I lead with <span className="text-AAsecondary keyword-hover">conviction</span>, but I stay{" "}
