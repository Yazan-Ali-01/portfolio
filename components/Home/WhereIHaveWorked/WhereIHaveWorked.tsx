...
import Osous from "./Descriptions/Osous";
import NmoAI from "./Descriptions/NmoAI";
import RoyalClass from "./Descriptions/RoyalClass";
import DrivenForbes from "./Descriptions/DrivenForbes";
export default function WhereIHaveWorked() {
  ...
  const [DescriptionJob, setDescriptionJob] = React.useState("DrivenForbes");
  return (
...
const CompaniesBar = props => {
  ...
  const CompanyButton = props => {
    return (
      <button
        ...
        className={`flex-none md:text-sm text-[0.6rem] text-center md:text-left  hover:text-AAsecondary
             hover:bg-ResumeButtonHover rounded  font-mono  px-1
             py-3 md:pl-6 md:px-4 md:w-52 w-32 duration-500
             ${
  ...
  return (
    ...
    >
      {/* // ? left bar Holder */}
      <div
        className=" hidden md:block bg-gray-500 relative h-0.5 w-34 md:h-[345px] translate-y-1 md:w-0.5  
